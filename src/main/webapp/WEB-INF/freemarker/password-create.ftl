            ...
            <table width="650" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style="padding:20px;">
                        Hi ${firstName},<br/>
                        <br/>
                        A <strong>Business Cloud</strong> account has been created successfully for you.
                        <br/>
                        <br/>
                        Please click the following link to set your password:<br/>
                        <br/>
                        <div style="text-indent: 20px;"><a href="${resetUrl}">Set my password</a></div>
                        <br/>
                        If you encounter any problems setting your password please send an email to
