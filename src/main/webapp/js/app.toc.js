function getTOC(){
	...
	return '\
Company Website Terms of Use<br />\
<br />Welcome to the Infor website (the "Company Website"). This document explains the terms and conditions for using the Company Website (the "Terms of Use"). By using the Company Website, you consent to these Terms of Use and any new version of such posted since your last visit.\
\
<br />These Terms of Use apply to any person or entity using and/or browsing the Company Website ("User"), including Company customers who are authorized to register to use the customer portal (the "Customer Portal").\
\
...
<br />\
<br />Using Company Content & Services<br />\
...
\
<br />Technology & Data Transfer<br />\
...
\
<br />Right To Rely On Instructions<br />\
...
<br />\
Notice to California Residents<br />\
